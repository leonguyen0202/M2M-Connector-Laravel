        ...
        if (call_user_func_array('Request::is', ['dashboard'])) {
            ...
            if (count($url) < 3) {
                ...
                if (strtolower($url[2]) != 'create') {
                    return "<a href='".route('dashboard.index')."' style='text-decoration:none;'>".__('backend.dashboard')."</a>&nbsp;/&nbsp;<a href='".route(Str::plural(strtolower($url[1])).'.index')."' style='text-decoration:none;'>".Str::singular(ucfirst($url[1]))."</a>&nbsp;/&nbsp;".ucfirst($url[2])."&nbsp;".Str::singular(ucfirst($url[1]))."";
