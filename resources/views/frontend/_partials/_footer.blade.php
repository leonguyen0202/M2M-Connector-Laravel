<div class="cd-section" id="teams" @yield('footer_class')>
    <!--     *********    TEAM 2     *********      -->
    <div class="team-2">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ml-auto mr-auto text-center">
                    ...
                    <h4 class="description">This is the paragraph where you can write more details about your team. Keep
                        you user engaged by providing meaningful information.</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                        ...
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img img-raised rounded"
                                    src="{{asset('images/examples/card-profile1.jpg')}}" />
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card card-profile card-plain">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img img-raised rounded"
                                    src="{{asset('images/examples/card-profile2.jpg')}}" />
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card card-profile card-plain">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img img-raised rounded"
                                    src="{{asset('images/examples/card-profile3.jpg')}}" />
                            </a>
                        </div>
                        <div class="card-body">
